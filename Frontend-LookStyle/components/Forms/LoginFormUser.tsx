        ...
        <div className="flex items-center justify-center w-full lg:p-12">
          <div className="flex items-center xl:p-10">
            <form
              ...
              className="flex flex-col w-full h-full py-6 px-14 text-center bg-white shadow-xl border rounded-2xl"
            >
              ...
              <h4 className="mb-3 text-4xl font-extrabold text-dark-grey-900">
                ¡Bienvenido de nuevo!
              </h4>
              ...
              <div className="py-8">
                ...
                <input
                  ...
                  placeholder="peopleemail@gmail.com"
                  className="flex items-center w-full px-5 py-3 mr-2 text-sm font-medium border outline-1 outline-primarycolor-pc focus:bg-grey-400 mb-7 placeholder:text-grey-700 bg-grey-200 text-dark-grey-900 rounded-2xl"
                />
                <label className="mb-2 text-sm text-start text-grey-900">
                  Contraseña
                </label>
                <input
                  ...
                  placeholder="*************"
                  className="flex items-center w-full px-5 py-3 mb-5 mr-2 text-sm font-medium border outline-1 outline-primarycolor-pc focus:bg-grey-400 placeholder:text-grey-700 bg-grey-200 text-dark-grey-900 rounded-2xl"
                />
