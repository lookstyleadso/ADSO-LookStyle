                    ...
                    <div className="flex items-center xl:p-10">
                        <form onSubmit={handleSubmit} className="flex flex-col w-full h-full py-6 px-14 text-center bg-white shadow-xl border rounded-2xl">
                            <div className="flex items-center justify-center w-full pb-8">
                                <Image className="h-20 w-24" src="/logolookstyle.svg" alt="Google" width={50} height={50} />
                            </div>
                            <h4 className="mb-3 text-4xl font-extrabold text-dark-grey-900">¡Bienvenido de nuevo!</h4>
                            ...
                            <div className='py-8'>
                                <label className="mb-2 text-sm text-start text-grey-900">Correo</label>
                                ...
                                <label className="mb-2 text-sm text-start text-grey-900">Contraseña</label>
                                ...
                                <div className="flex flex-row justify-between mb-8">
                                    <label className="relative inline-flex items-center mr-3 cursor-pointer select-none">
                                        <input className="dark:border-white-400/20 dark:scale-100 transition-all duration-500 ease-in-out dark:hover:scale-110 dark:checked:scale-100 cursor-pointer w-3 h-3" type="checkbox" />
