...
function UserRegister() {
  ...
  const agregarUsuario = async (nombre, lastname, correo, password, phone) => {
    let response = await fetch("https://adso-lookstyle.onrender.com/api/v1/users/", {
      method: "POST",
      body: JSON.stringify({
        name: nombre,
        last_name: lastname,
...
<<<<<<< HEAD:Frontend-LookStyle/components/Forms/UserRegister.jsx
=======
export default function RegisterFormUser() {
>>>>>>> e6000ba7382e8f6a0b4ac334f6c865201219a253:Frontend-LookStyle/components/Forms/RegisterFormUser.jsx
  return (
