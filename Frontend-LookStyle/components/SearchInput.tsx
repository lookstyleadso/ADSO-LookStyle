    ...
    <div className="sm:col-span-2">
      <div className="mt-2.5 flex gap-2 justify-center">
        ...
        <button
          type="submit"
          title="search"
          className="flex-none rounded-md px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-secundarycolor-sc to-primarycolor-pc transition-all hover:from-primarycolor-pc hover:to-secundarycolor-sc hover:text-white"
        >
          <FaSearch />
        </button>
      </div>
